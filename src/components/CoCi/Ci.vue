        ...
        <div class="flex justify-center flex-col items-center">
            ...
            <form v-on:submit.prevent="submitHandling" method="post">
                <div class="w-4/5 md:w-2/4 grid grid-flow-row gap-5 mb-44 mt-10" >
                    ...
                    <selectCheck v-model="magangType" label="Jenis Program Magang" :required="true" :disabled="false" name="magangType" :data="[{label : 'Magang Kantor Pusat', value :'Magang Kantor Pusat'},{label : 'Magang PRADA',value:'Magang Darat'},{label : 'Magang PRALA',value:'Magang Laut'}]"/>
