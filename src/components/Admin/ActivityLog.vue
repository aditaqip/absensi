<template>
          ...
          <div class="p-5 bg-slate-100 h-full">
            <div class="bg-white p-4 rounded-lg mb-4">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="my-2 lg:col-span-1">
                    <label for="searchActivity" class="block mb-2 text-lg font-bold">Cari Aktivitas</label>
                  <input
                ...
                <div class="my-2 lg:col-span-1">
                    <label for="searchActivity" class="block mb-2 text-lg font-bold">Cari Waktu</label>
                  <input
                    v-model="searchTime"
                    type="text"
                    class="w-full px-3 py-2 border rounded-md"
                ...
                <div class="my-2 lg:col-span-1">
                    <label for="searchActivity" class="block mb-2 text-lg font-bold">Cari User</label>
                  <input
                    v-model="searchUser"
                    type="text"
                    class="w-full px-3 py-2 border rounded-md"
                ...
                <div class="my-2 lg:col-span-1">
                    <label for="searchActivity" class="block mb-2 text-lg font-bold">Cari Perubahan</label>
                  <input
            ...
            <div class="px-5 py-3 rounded-lg bg-white">
              <table class="w-full" cellspacing="10" cellpadding="5">
                ...
                <tbody>
                  <tr v-for="(log, index) in filteredLogs" :key="index" class="border-b-[1px]">
                    ...
                    <td class="text-center py-2">
                      <button v-if="log.activity === 'Data updated'" @click="showDetails(log)" class="px-2 py-1 bg-blue-500 text-white rounded">Details</button>
                    </td>
                  </tr>
                </tbody>
              </table>
    ...
    computed: {
      ...
      filteredLogs() {
        return this.logs.filter(log => {
          return (
            log.activity.toLowerCase().includes(this.searchActivity.toLowerCase()) &&
  ...
  methods: {
    generateRandomLogs(count) {
      ...
      const users = ["John Doe", "Jane Smith", "Alice Johnson", "Bob Brown", "Emily Davis"];
      const changes = ["Updated the user data", "Modified the product information", "Added new content"];
