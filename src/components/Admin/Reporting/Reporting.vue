      ...
      <div class="p-5 bg-slate-100 h-full">
        ...
        >
          ...
          <div class="flex justify-between items-center flex-wrap mt-2">
            ...
            <div class="flex justify-around gap-10">
              ...
              <div class="relative">
                ...
                <div
                  v-show="dropdownOpen"
                  class="absolute bg-white border border-gray-200 mt-2 py-2 w-48 rounded-md shadow-lg z-10"
                >
          ...
          <div class="my-3" :class="!searchState && 'hidden'">
            <input
              type="text"
              class="border w-full rounded border-black pr-1 focus:outline-none py-1 pl-3"
              placeholder="Search"
              v-model="seacrh"
              v-on:keyup="onSearch"
            />
          ...
          <table class="w-full">
            ...
            <tbody v-if="typeof PesertaIndex != 'undefined'">
              <tr v-for="(index, items) in PesertaIndex">
                ...
                <td class="text-center py-2 p-3">{{ index.tanggalmsk }}</td>
